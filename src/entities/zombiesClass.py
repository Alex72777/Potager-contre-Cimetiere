...
ZOMBIES: dict[str, Zombie] = {
    ...
    'speedy_zombie': Zombie(name="Speedy Zombie", health=150, attack_damage=80),
    ...
    'berserker_zombie': Zombie(name="Berserker Zombie", health=250, attack_damage=180),
    ...
    'behemoth_zombie': Zombie(name="Behemoth Zombie", health=1000, attack_damage=200),
    ...
    'boss_ogre': Zombie(name="Ogre", health=3000, attack_damage=300, is_boss=True),
